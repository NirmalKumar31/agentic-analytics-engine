...
207 adversarial tests cover writes, DDL, `COPY`, `ATTACH`, extension loading,
...
639 Python tests, 35 frontend tests, and 12 browser tests run on Chromium
